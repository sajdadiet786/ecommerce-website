            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="destroyCategory">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Yes. Detete</button>
                    </div>
                        ...
                        <tbody>
                            @foreach ($categories as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <img src="{{ $item->image }}" width="200px" height="200px" alt="Img">
                                    </td>
                                    <td>{{ $item->status == '1' ? 'Hidden' : 'Visible' }}</td>
                                    <td>
                                        <a href="{{ route('category.edit', ['category_id' => $item->id]) }}"
